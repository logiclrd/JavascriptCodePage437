...
function ConvertUnicodeToCP437PrivateUseArea(str)
{
	var result = "";
	...
	for (var i = 0; i < str.length; i++)
	{
		switch (str.charCodeAt(i))
		{
			...
			case 0x25D8: result += '\uE008'; break; // ◘
			case 0x25CB: result += '\uE009'; break; // ○
			case 0x25D9: result += '\uE00A'; break; // ◙
			case 0x2642: result += '\uE00B'; break; // ♂
			case 0x2640: result += '\uE00C'; break; // ♀
			case 0x266A: result += '\uE00D'; break; // ♪
			case 0x266B:
			case 0x266C: result += '\uE00E'; break; // ♬
			case 0x066D:
			case 0x06DE:
			...
			case 0x2502: result += '\uE0B3'; break; // │
			case 0x2524: result += '\uE0B4'; break; // ┤
			case 0x2561: result += '\uE0B5'; break; // ╡
			case 0x2562: result += '\uE0B6'; break; // ╢
			case 0x2556: result += '\uE0B7'; break; // ╖
			case 0x2555: result += '\uE0B8'; break; // ╕
			case 0x2563: result += '\uE0B9'; break; // ╣
			case 0x2551: result += '\uE0BA'; break; // ║
			case 0x2557: result += '\uE0BB'; break; // ╗
			case 0x255D: result += '\uE0BC'; break; // ╝
			case 0x255C: result += '\uE0BD'; break; // ╜
			case 0x255B: result += '\uE0BE'; break; // ╛
			case 0x2510: result += '\uE0BF'; break; // ┐
			case 0x2514: result += '\uE0C0'; break; // └
			case 0x2534: result += '\uE0C1'; break; // ┴
			case 0x252C: result += '\uE0C2'; break; // ┬
			case 0x251C: result += '\uE0C3'; break; // ├
			case 0x2500: result += '\uE0C4'; break; // ─
			case 0x253C: result += '\uE0C5'; break; // ┼
			case 0x255E: result += '\uE0C6'; break; // ╞
			case 0x255F: result += '\uE0C7'; break; // ╟
			case 0x255A: result += '\uE0C8'; break; // ╚
			case 0x2554: result += '\uE0C9'; break; // ╔
			case 0x2569: result += '\uE0CA'; break; // ╩
			case 0x2566: result += '\uE0CB'; break; // ╦
			case 0x2560: result += '\uE0CC'; break; // ╠
			case 0x2550: result += '\uE0CD'; break; // ═
			case 0x256C: result += '\uE0CE'; break; // ╬
			case 0x2567: result += '\uE0CF'; break; // ╧
			case 0x2568: result += '\uE0D0'; break; // ╨
			case 0x2564: result += '\uE0D1'; break; // ╤
			case 0x2565: result += '\uE0D2'; break; // ╥
			case 0x2559: result += '\uE0D3'; break; // ╙
			case 0x2558: result += '\uE0D4'; break; // ╘
			case 0x2552: result += '\uE0D5'; break; // ╒
			case 0x2553: result += '\uE0D6'; break; // ╓
			case 0x256B: result += '\uE0D7'; break; // ╫
			case 0x256A: result += '\uE0D8'; break; // ╪
			case 0x2518: result += '\uE0D9'; break; // ┘
			case 0x250C: result += '\uE0DA'; break; // ┌
			case 0x2588: result += '\uE0DB'; break; // █
			case 0x2584: result += '\uE0DC'; break; // ▄
			case 0x258C: result += '\uE0DD'; break; // ▌
			case 0x2590: result += '\uE0DE'; break; // ▐
			case 0x2580: result += '\uE0DF'; break; // ▀
			case 0x03B1: result += '\uE0E0'; break; // α
			case 0x00DF: result += '\uE0E1'; break; // ß
			case 0x0393: result += '\uE0E2'; break; // Γ
			case 0x03C0: result += '\uE0E3'; break; // π
			case 0x03A3: result += '\uE0E4'; break; // Σ
			case 0x03C3: result += '\uE0E5'; break; // σ
			case 0x00B5: result += '\uE0E6'; break; // µ
			case 0x03C4: result += '\uE0E7'; break; // τ
			case 0x03A6: result += '\uE0E8'; break; // Φ
			case 0x0398: result += '\uE0E9'; break; // Θ
			case 0x03A9: result += '\uE0EA'; break; // Ω
			case 0x03B4: result += '\uE0EB'; break; // δ
			case 0x221E: result += '\uE0EC'; break; // ∞
			case 0x03C6: result += '\uE0ED'; break; // φ
			case 0x03B5: result += '\uE0EE'; break; // ε
			case 0x2229: result += '\uE0EF'; break; // ∩
			case 0x2261: result += '\uE0F0'; break; // ≡
			case 0x00B1: result += '\uE0F1'; break; // ±
			case 0x2265: result += '\uE0F2'; break; // ≥
			case 0x2264: result += '\uE0F3'; break; // ≤
			case 0x2320: result += '\uE0F4'; break; // ⌠
			case 0x2321: result += '\uE0F5'; break; // ⌡
			case 0x00F7: result += '\uE0F6'; break; // ÷
			case 0x2248: result += '\uE0F7'; break; // ≈
			case 0x00B0: result += '\uE0F8'; break; // °
			case 0x2219: result += '\uE0F9'; break; // ∙
			case 0x00B7: result += '\uE0FA'; break; // ·
			case 0x221A: result += '\uE0FB'; break; // √
			case 0x207F: result += '\uE0FC'; break; // ⁿ
			case 0x00B2: result += '\uE0FD'; break; // ²
			case 0x25A0: result += '\uE0FE'; break; // ■
...
function ConvertUnicodeToCP437PrivateUseAreaControlCharactersOnly(str)
{
	var result = "";
